// Test script to identify gender issue
const testGenderIssue = async () => {
  console.log('🔍 Identifying gender issue...\n')
  ...
  console.log('🎉 Gender issue test completed!')
...
// Run the test
testGenderIssue().catch(console.error)
