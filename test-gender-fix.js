// Test script to fix gender issue
const testGenderFix = async () => {
  console.log('🔍 Fixing gender issue...\n')
  ...
  console.log('🎉 Gender fix test completed!')
...
// Run the test
testGenderFix().catch(console.error)
