// Test script to check gender in browser
const testGenderBrowser = async () => {
  console.log('🔍 Checking gender in browser...\n')
  ...
  console.log('🎉 Gender browser test completed!')
...
// Run the test
testGenderBrowser().catch(console.error)
