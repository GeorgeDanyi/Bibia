// Test script to debug gender issue
const testGenderDebug = async () => {
  console.log('🔍 Debugging gender issue...\n')
  ...
  try {
    ...
    // Check for gender key assignment
    if (html.includes('gender: gender.key as')) {
  ...
  try {
    ...
    // Check for gender in payload
    if (html.includes('gender: answers.gender || \'any\'')) {
      console.log('✅ Gender in searchRequest found in questionnaire')
    } else {
      console.log('❌ Gender in searchRequest NOT found in questionnaire')
    }
    
    // Check for strictGender in payload
    if (html.includes('strictGender: Boolean(answers.strictGender)')) {
      console.log('✅ strictGender in searchRequest found in questionnaire')
    } else {
      console.log('❌ strictGender in searchRequest NOT found in questionnaire')
    }
  ...
  console.log('🎉 Gender debug test completed!')
...
// Run the test
testGenderDebug().catch(console.error)
